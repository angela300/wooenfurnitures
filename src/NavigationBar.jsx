...
export const NavigationBar = ({ products }) => {
  ...
  key: "DINING",
  label: "DINING",
  items: ["Dining Tables", "Dining Chairs", "Bar Stools"]
},
{
  key: "OFFICE",
  label: "OFFICE",
  items: ["Office Desks", "Office Chairs", "Book Shelves"]
},
{
  key: "OUTDOOR",
  label: "OUTDOOR",
  items: ["Patio Sets", "Garden Chairs", "Outdoor Tables"]
},
{
  key: "KITCHEN",
  label: "KITCHEN",
  items: ["Kitchen Cabinets", "Kitchen Islands", "Storage Racks"]
},
{
  key: "WARDROBES",
  label: "WARDROBES",
  items: ["Sliding Wardrobes", "Hinged Wardrobes", "Walk-in Closets"]
},
{
  key: "MATTRESSES",
  label: "MATTRESSES",
  items: ["Orthopedic Mattress", "Foam Mattress", "Spring Mattress"]
},
{
  key: "DOORS",
  label: "DOORS & FRAMES",
  items: ["Mahogany Doors", "Panel Doors", "Security Doors"]
},
{
  key: "LIGHTING",
  label: "LIGHTING",
  items: ["Pendant Lights", "Wall Lights", "Floor Lamps"]
},
{
  key: "DECOR",
  label: "HOME DECOR",
  items: ["Wall Art", "Mirrors", "Decor Shelves"]
},
{
  key: "CARPETS",
  label: "CARPETS & RUGS",
  items: ["Area Rugs", "Modern Carpets", "Traditional Rugs"]
},
{
  key: "COFFEE",
  label: "COFFEE TABLES",
  items: ["Glass Coffee Tables", "Wooden Coffee Tables", "Marble Coffee Tables"]
},
{
  key: "CONSOLE",
  label: "CONSOLE TABLES",
  items: ["Hallway Consoles", "Entryway Tables", "Modern Consoles"]
},
{
  key: "BEDDING",
  label: "BEDDING",
  items: ["Bed Sheets", "Duvet Covers", "Pillows"]
},
{
  key: "TV",
  label: "ENTERTAINMENT",
  items: ["TV Units", "Media Consoles", "Wall Panels"]
},
{
  key: "KIDS",
  label: "KIDS FURNITURE",
  items: ["Kids Beds", "Study Desks", "Toy Storage"]
},
{
  key: "BATHROOM",
  label: "BATHROOM",
  items: ["Bathroom Cabinets", "Vanity Units", "Storage Shelves"]
},
{
  key: "STORAGE",
  label: "STORAGE SOLUTIONS",
  items: ["Shoe Racks", "Closet Organizers", "Storage Boxes"]
},
{
  key: "HEADBOARDS",
  label: "HEADBOARDS",
  items: ["Upholstered Headboards", "Wooden Headboards", "Modern Headboards"]
},
{
  key: "RECLINERS",
  label: "RECLINER CHAIRS",
  items: ["Manual Recliners", "Electric Recliners", "Leather Recliners"]
},
{
  key: "SIDEBOARDS",
  label: "SIDEBOARDS",
  items: ["Buffet Cabinets", "Modern Sideboards", "Wooden Sideboards"]
}
]
